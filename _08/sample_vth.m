...
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\_08_novo\02_vth
...
if sel == 4 
op2 =  rdcelpa('02_vth/n_dir_1g_vth_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('02_vth/n_dir_fbg_vth_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('02_vth/n_dir_2g_vth_dd_iv.elpa','*',[],op2);
...
%%%%1G, FBG, 3G
% aux = 1
% if aux == 2 %versao errada dos arquivos de entrada
% opT(1).V_g = op2(1).V_g(5:7); %0.2759	0.3448    0.4138
% opT(1).I_d = op2(1).I_d(5:7);

% opT(2).V_g = op2(2).V_g(5:7);
% opT(2).I_d = op2(2).I_d(5:7);

% opT(3).V_g = op2(3).V_g(42:47); % 0.4211    0.3947    0.3684    0.3421    0.3158    0.2895
% opT(3).I_d = op2(3).I_d(42:47);

% opT(4).V_g = op2(4).V_g(5:7);
% opT(4).I_d = op2(4).I_d(5:7);
% end

%1G
opT(1).V_g = op2(1).V_g(6:9); %0.6206 0.6896 0.7586
opT(1).I_d = op2(1).I_d(6:9);

%FBG
opT(2).V_g = op2(2).V_g(7:11);
opT(2).I_d = op2(2).I_d(7:11);

%2G
opT(3).V_g = op2(3).V_g(17:34);
opT(3).I_d = op2(3).I_d(17:34);
