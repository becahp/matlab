...
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\TFET2\03_backgate\Adapt
...
op2 =  rdcelpa('nHP_BG_adpt_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('nHP_BG_adpt_v2_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('HP/nHP_BG_000_dd_iv.elpa','*',[],op2);

op2 =  rdcelpa('nLP_BG_adpt_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('nLP_BG_adpt_v2_dd_iv.elpa','*',[],op2);
...
legend({'VBG Adapt', 'VBG = 0.0V'}, 'Location', 'best');
legend('boxoff')


print('var_BG_adapt', '-depsc');
%print('var_BG_adapt2', '-depsc');