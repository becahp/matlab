...
op2 =  rdcelpa('nHP_dv_05_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_dv_06_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_dv_07_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_dv_08_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('nHP_tbox_25_dd_iv.elpa','*',[],op2); %padrão

op2 =  rdcelpa('nLP_dv_05_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_dv_06_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_dv_07_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_dv_08_dd_iv.elpa','*',[],op2);
