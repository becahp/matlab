...
op2 =  rdcelpa('nHP_dv_01_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_dv_02_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_dv_03_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_tbox_25_dd_iv.elpa','*',[],op2); %padrão

op2 =  rdcelpa('nLP_dv_01_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_dv_02_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_dv_03_dd_iv.elpa','*',[],op2);
...
legend({'++0.18', '+-0.18', '-+0.18', '--0.18'}, 'Location', 'best');
