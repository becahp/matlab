...
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\TFET2\02_otimizacao\01_vpg\Adapt\vpg_adapt_bg_1
...
if i == 1
	[A,a,fl] = readELPA('vpg_adapt_bg_1/vpg_adapt_bg_1_op1_dd_inqu.elpa'); %0.0V 
end

if i == 2
	[A,a,fl] = readELPA('vpg_adapt_bg_1/vpg_adapt_bg_1_op15_dd_inqu.elpa'); %0.14V 
end

if i == 3
	[A,a,fl] = readELPA('vpg_adapt_bg_1/vpg_adapt_bg_1_op21_dd_inqu.elpa'); %0.2V 
end

if i == 4
	[A,a,fl] = readELPA('vpg_adapt_bg_1/vpg_adapt_bg_1_op41_dd_inqu.elpa'); %0.4V 
end
...
if i == 1
	print('vpg_adapt_vbg_1_0V', '-depsc'); %0.8V
end        
           
if i == 2  
	print('vpg_adapt_vbg_1_014V', '-depsc'); %0.6V 
end        
           
if i == 3  
	print('vpg_adapt_vbg_1_02V', '-depsc');%0.4V 
end        
           
if i == 4  
	print('vpg_adapt_vbg_1_04V', '-depsc');%0.2V 
end        
