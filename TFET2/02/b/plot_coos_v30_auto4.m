...
if i == 1
	[A,a,fl] = readELPA('nLP_tbox_10/nLP_tbox_10_op1_dd_inqu.elpa'); %0.8V 
end

if i == 2
	[A,a,fl] = readELPA('nLP_tbox_15/nLP_tbox_15_op101_dd_inqu.elpa'); %0.2V 
end

if i == 3
	[A,a,fl] = readELPA('nLP_tbox_25/nLP_tbox_25_op101_dd_inqu.elpa'); %0.4V 
end
...
if i == 1
	print('nLP_tbox_10', '-depsc'); %0.8V
end        
           
if i == 2  
	print('nLP_tbox_15', '-depsc'); %0.6V 
end        
           
if i == 3  
	print('nLP_tbox_25', '-depsc');%0.4V 
end        
