...
if i == 1
	[A,a,fl] = readELPA('nLP_vpg_010/nLP_vpg_010_op101_dd_inqu.elpa'); %0.8V 
end

if i == 2
	[A,a,fl] = readELPA('nLP_vpg_000/nLP_vpg_000_op101_dd_inqu.elpa'); %0.6V 
end

if i == 3
	[A,a,fl] = readELPA('nLP_vpg_102/nLP_vpg_102_op101_dd_inqu.elpa'); %0.4V 
end

if i == 4
	[A,a,fl] = readELPA('nLP_vpg_104/nLP_vpg_104_op101_dd_inqu.elpa'); %0.2V 
end
...
if i == 1
	print('nLP_vpg_010', '-depsc'); %0.8V
end        
           
if i == 2  
	print('nLP_vpg_000', '-depsc'); %0.6V 
end        
           
if i == 3  
	print('nLP_vpg_102', '-depsc');%0.4V 
end        
           
if i == 4  
	print('nLP_vpg_104', '-depsc');%0.2V 
end        
