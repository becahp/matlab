...
%op2 =  rdcelpa('HP/nHP_vpg_110_dd_iv.elpa','*',[],op2);
end 
...
if aux == 1
%legend({'vpg = 0V','vpg = 0.2V','vpg = 0.4V','vpg = 0.6V','vpg = 0.8V', 'vpg = 1V'}, 'Location', 'best');
legend({'vpg = 1.0V','vpg = 0.8V','vpg = 0.6V','vpg = 0.4V','vpg = 0.2V', 'vpg = 0.0V'}, 'Location', 'best');
end
if aux ==2
legend({'vpg = 0.0V','vpg = -0.2V','vpg = -0.4V','vpg = -0.6V','vpg = -0.8V', 'vpg = -1.0V'}, 'Location', 'best');
end
legend('boxoff')


auxStr = ['VPG_' num2str(aux)];
print(auxStr, '-depsc');