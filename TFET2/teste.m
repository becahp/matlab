...
op2 =  rdcelpa('nHP_qual.elpa','*',[],op2);
op2 =  rdcelpa('nHP_tbox_25\nHP_tbox_25_dd_iv.elpa','*',[],op2); %padrão


op2 =  rdcelpa('nLP_qual.elpa','*',[],op2);
op2 =  rdcelpa('nLP_tbox_25\nLP_tbox_25_dd_iv.elpa','*',[],op2); %padrão
...
legend({'qual', 'vbg = 0'}, 'Location', 'best');

legend('boxoff')

%print('var_tbox', '-depsc');