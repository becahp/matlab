...
op2 =  rdcelpa('nHP_BG_neg_dd_iv2.elpa','*',[],op2);
...
h(3) = semilogy(op2(3).V_g,op2(3).I_d); %exp

h(4) = semilogy(op2(4).V_g,op2(4).I_d); %LP
h(5) = semilogy(op2(5).V_g,op2(5).I_d); %LP
...
legend({'HP>0', 'HP<0 v1', 'HP<0 v2', 'HP<0 v3', 'HP<0 v4'}, 'location', 'best');
legend('boxoff');
