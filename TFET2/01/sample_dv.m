...
op2 =  rdcelpa('nFET_mini_v1_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nFET_mini_v2_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nFET_mini_v3_dd_iv.elpa','*',[],op2);
...
legend({'dv = 0.0','dv = -0.1','dv = -0.15','dv = -0.2'}, 'Location', 'best');
legend('boxoff')

print('miniFET_dv', '-depsc');
