...
if aux == 1
op2 =  rdcelpa('tFET_mini2_v1_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('tFET_mini2_v2_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('tFET_mini2_v3_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('tFET_mini2_v4_dd_iv.elpa','*',[],op2);
end

if aux == 2
op2 =  rdcelpa('tFET_mini2_v1_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('tFET_mini2_v5_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('tFET_mini2_v6_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('tFET_mini2_v2_dd_iv.elpa','*',[],op2);
end
