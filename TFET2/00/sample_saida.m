...
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\TFET2\00_ideal\01_saida
...
legend({'nHP'}, 'Location', 'best');
legend('boxoff')

print('ideal_nHP_s', '-depsc');


figure
h(1) = plot(op2(2).V_d,op2(2).I_d );
...
legend({'nLP'}, 'Location', 'best');
legend('boxoff')

print('ideal_nLP_s', '-depsc');