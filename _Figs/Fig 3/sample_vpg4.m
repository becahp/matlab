...
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\TFET2\02_otimizacao\01_vpg\HP1
...
op2 =  rdcelpa('HP1/nHP_vpg_006_BG_010_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('HP/nHP_vpg_008_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('HP1/nHP_vpg_010_BG_010_dd_iv.elpa','*',[],op2);
...
legend([h(1) h(2)],{'vpg = |0.6|V, vbg=1V','vpg = |0.8|V, vbg=1V'}, 'Location', 'best');  % Only the blue and green lines appear in the legend
