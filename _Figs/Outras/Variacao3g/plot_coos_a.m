...
if aux == 1
%VPG= 1.2V, VGS = 0.55V
%[A,a,fl] = readELPA('n_dir_3g_op9_dd_inqu.elpa');  %0.5V
[A,a,fl] = readELPA('n_esq_3g_op9_dd_inqu.elpa');  %-0.5V
end

if aux ==2
%VPG= 1.8V, VGS = 0.55V
%[A,a,fl] = readELPA('n_3g_d16_program_18V_op45_dd_inqu.elpa');  %0.5V
[A,a,fl] = readELPA('n_3g_d16_program_18V_op26_dd_inqu.elpa');  %-0.5V
end
