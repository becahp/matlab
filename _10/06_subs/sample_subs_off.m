...
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\_10_revisao\12_substrato\off
...
%op2(3).I_s = op2(3).I_s(1:40); %
%op2(3).V_g = op2(3).V_g(1:40);
...
%legend([h(1), h(2), h(3), h(5), ], {'1G','FBG','2G', '3G'}, 'Location', 'best');  % Only the blue and green lines appear in the legend


%legend({'1G','FBG', '3G'}, 'Location', 'best');  % Only the blue and green lines appear in the legend
legend([h(1),h(3),h(5)],{'1G','FBG', '3G'}, 'Location', 'best');  % Only the blue and green lines appear in the legend
