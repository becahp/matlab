...
op7 =  rdcelpa('old_p_dir_1g_d16_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('old_p_esq_1g_d16_dd_iv.elpa','*',[],op7);
...
if aux == 1
legend([h(1) h(3) h(5) h(7) ],{'1g dir','1g esq', '1g old dir','1g old esq'}, 'Location', 'best');  % Only the blue and green lines appear in the legend
%legend('boxoff')
end
