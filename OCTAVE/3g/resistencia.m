...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 1G
op2 = [];
op2 =  rdcelpa('n_1g_vgs_2_dd_iv.elpa','*',[],op2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FBG
op2 = [];
op2 =  rdcelpa('n_fbg_vgs_2_dd_iv.elpa','*',[],op2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 2G
op2 = [];
op2 =  rdcelpa('n_2g_2V_vgs_2_dd_iv.elpa','*',[],op2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 3G
op2 = [];
op2 =  rdcelpa('n_3g_vds_vg_12_dd_iv.elpa','*',[],op2);
