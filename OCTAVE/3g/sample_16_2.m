...
if aux == 1
op2 =  rdcelpa('n_dir_3g_v1_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('n_esq_3g_v1_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('p_dir_3g_v1_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('p_esq_3g_v1_dd_iv.elpa','*',[],op2);
end

op7 =  rdcelpa('old_n_esq_3g_d16_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('old_n_dir_3g_d16_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('old_p_dir_3g_d16_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('old_p_esq_3g_d16_dd_iv.elpa','*',[],op7);
...
h(5) = semilogy(op7(1).G,op7(1).Isum); % 3g antigo
h(6) = semilogy(op7(2).G,op7(2).Isum); % 3g antigo
h(7) = semilogy(op7(3).G,op7(3).Isum); % 3g antigo
h(8) = semilogy(op7(4).G,op7(4).Isum); % 3g antigo
...
if aux == 1
legend([h(1) h(3) h(5) h(7) ],{'3G dir','3G esq', '3G old dir','3G old esq'}, 'Location', 'best');  % Only the blue and green lines appear in the legend
%legend('boxoff')
end

if aux == 2
legend([h(1) h(3) ],{'3G','3G old'}, 'Location', 'best');  % Only the blue and green lines appear in the legend
%legend('boxoff')
end