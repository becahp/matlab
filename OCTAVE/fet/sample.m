...
op2 =  rdcelpa('p_dir_fet_d24_b000_bbt0_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('p_esq_fet_d24_b000_bbt0_dd_iv.elpa','*',[],op2);
...
h(2) = semilogy(op2(1).V_g(op2(1).n_iter>0),op2(1).I_s(op2(1).n_iter>0)); 
h(3) = semilogy(op2(2).V_g(op2(2).n_iter>0),op2(2).I_s(op2(2).n_iter>0)); 
...
legend([h(1) h(3) ],{'Experimental','d = 2.4 (bbt = 0, sb = 0)'}, 'Location', 'best');  % Only the blue and green lines appear in the legend
%legend('boxoff')