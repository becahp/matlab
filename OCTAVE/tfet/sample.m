...
op2 =  rdcelpa('nHP_PGS_10_better_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_PGS_10_better_dd_iv.elpa','*',[],op2);
...
h(2) = semilogy(op2(2).V_g,op2(2).I_s); %3G
h(3) = semilogy(op2(3).V_g,op2(3).I_s); %FBG
h(4) = semilogy(op2(4).V_g,op2(4).I_s); %FBG
...
legend([h(1) h(3) ],{'vpg = 1V','better'}, 'Location', 'best');  % Only the blue and green lines appear in the legend
%legend('boxoff')