...
op7(1).jn = abs(op7(1).jn);
op7(1).jn_therm = abs(op7(1).jn_therm);
op7(1).jn_diff = abs(op7(1).jn_diff);
op7(1).jn_drift = abs(op7(1).jn_drift);
op7(1).jn_tun = abs(op7(1).jn_tun);


figure
h(1) = semilogy(op7(1).x,op7(1).jn );
hold
h(2) = semilogy(op7(1).x,op7(1).jn_tun );
h(3) = semilogy(op7(1).x,op7(1).jn_therm);

% h(2) = semilogy(op7(1).x,op7(1).jn_therm );
% h(3) = semilogy(op7(1).x,op7(1).jn_diff);
% h(4) = semilogy(op7(1).x,op7(1).jn_drift );
% h(5) = semilogy(op7(1).x,op7(1).jn_tun );
...
% legend([h(1) h(2) h(3) h(4) h(5)],...
    % {'jn', 'jn_{therm}','jn_{diff}', 'jn_{drift}', 'jn_{tun}'},'Location', 'best'); 
