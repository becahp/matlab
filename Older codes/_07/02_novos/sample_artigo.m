...
%op2(1).I_s = abs(op2(1).I_s * 1.6);
%op2(2).I_s = abs(op2(2).I_s * 1.6);
%op2(3).I_s = abs(op2(3).I_s * 1.7);
%op2(3).V_g = op2(3).V_g + 0.055;
...
legend([h(1) h(2) h(3) h(4) h(5)],{'Experimental','d = 2.4nm','d = 2.4nm (bbt = 0)','d = 1.8nm', 'SB < 0'}, 'Location', 'southwest');  % Only the blue and green lines appear in the legend
