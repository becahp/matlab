...
aux = 1;
if aux == 1
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\_10_revisao\06_eps
%addpath C:\Users\becahp\UnB\Artigo\Simulacoes\_10_revisao\06_eps\p_artigo_d18_bbt1_subs
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\_10_revisao\06_eps\p_esq_artigo_d18_bbt1_subs
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\_10_revisao\06_eps\p_dir_artigo_d18_bbt1_subs

str = 'eps12_d';
end

if aux == 2
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\_10_revisao\06_eps\eps16
str = 'eps16_d';
end
...
if aux == 1
op2 =  rdcelpa('p_artigo_d24_bbt1_eps12_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('p_artigo_d24_bbt0_eps12_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('p_artigo_d18_bbt1_eps12_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('p_artigo_d18_bbt1_subs_dd_iv.elpa','*',[],op2);
...
if aux == 2
op2 =  rdcelpa('p_artigo_d24_bbt1_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('p_artigo_d24_bbt0_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('p_artigo_d18_bbt1_dd_iv.elpa','*',[],op2);
...
if pule == 1
i = 1;
elp.mat=[tres(:,1),tres(:,2)];
elp.var_names={'V_g','I_s'};
strAux = strcat(str, num2str(i));
elp.title = strAux;
