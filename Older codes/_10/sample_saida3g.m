...
%if aux == 1 
op2 =  rdcelpa('n_3g_03V_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('n_3g_06V_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('n_3g_09V_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('n_3g_12V_dd_iv.elpa','*',[],op2);

%op2 =  rdcelpa('p_3g_03V_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('p_3g_06V_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('p_3g_09V_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('p_3g_12V_dd_iv.elpa','*',[],op2);
%end
