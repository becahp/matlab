...
color_list=['r','b','r','b','b','b','b','r','r','r','r','r']; %op4 com 10 curvas

%color_list=['y','b','r','b','b','r','r','r','r']; %op4 com 6 curvas
%color_list=['r','b','r','b','b','b','b','b','r','r','r','r']; %op6
