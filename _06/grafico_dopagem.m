...
aux = 1;
% op7 =  rdcelpa('02_dopagem/p_esq_artigo_d18_b102_doping_dd_iv.elpa','*',[],op7);
% op7 =  rdcelpa('02_dopagem/p_dir_artigo_d18_b102_doping_dd_iv.elpa','*',[],op7);
% op7 =  rdcelpa('02_dopagem/p_esq_artigo_d18_b002_doping_dd_iv.elpa','*',[],op7);
% op7 =  rdcelpa('02_dopagem/p_dir_artigo_d18_b002_doping_dd_iv.elpa','*',[],op7);
...
op7 =  rdcelpa('1e8/p_esq_artigo_d18_b0025_doping_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('1e8/p_dir_artigo_d18_b0025_doping_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('1e8/p_esq_artigo_d18_b003_doping_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('1e8/p_dir_artigo_d18_b003_doping_dd_iv.elpa','*',[],op7);
end
...
op7 =  rdcelpa('1e7/p_esq_artigo_d18_b0025_doping_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('1e7/p_dir_artigo_d18_b0025_doping_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('1e7/p_esq_artigo_d18_b003_doping_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('1e7/p_dir_artigo_d18_b003_doping_dd_iv.elpa','*',[],op7);
end

op7 =  rdcelpa('eps12/p_esq_artigo_d18_b102_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('eps12/p_dir_artigo_d18_b102_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('eps12/p_esq_artigo_d18_b002_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('eps12/p_dir_artigo_d18_b002_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('eps12/p_esq_artigo_d18_b0025_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('eps12/p_dir_artigo_d18_b0025_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('eps12/p_esq_artigo_d18_b003_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('eps12/p_dir_artigo_d18_b003_dd_iv.elpa','*',[],op7);



% op6 = [];
%%op6 =  rdcelpa('02_dopagem/p_esq_artigo_d18_b102_doping_op16_dd_inqu.elpa','*',[],op6);
% op6 =  rdcelpa('12_artigo_dia18/p_esq_artigo_d18_b102_op16_dd_inqu.elpa','*',[],op6);
...
if aux == 1
legend([h(1) h(3) h(5) h(7) h(9) h(11) h(13) h(15)],...
    {'sb = -0.2, dopado 10^8', 'sb = 0.2, dopado 10^8', 'sb = 0.25, dopado 10^8',  'sb = 0.3, dopado 10^8'...
	'sb = -0.2','sb = 0.2','sb = 0.25','sb = 0.3'},'Location', 'best'); 
end

if aux ==2
legend([h(1) h(3) h(5) h(7) h(9) h(11) h(13) h(15)],...
    {'sb = -0.2, dopado 10^7', 'sb = 0.2, dopado 10^7', 'sb = 0.25, dopado 10^7',  'sb = 0.3, dopado 10^7'...
	'sb = -0.2','sb = 0.2','sb = 0.25','sb = 0.3'},'Location', 'best'); 
end
	
% legend([h(1) h(3) h(5) h(7)],...
    % {'sb = -0.2, dopado 10^8', 'sb = 0.2, dopado 10^8','sb = -0.2','sb = 0.2'},'Location', 'best'); 
	
% legend([h(1) h(3) h(5) h(7)],...
    % {'sb = -0.2, dopado 10^8', 'sb = 0.2, dopado 10^8','sb = -0.2 dopado 10^9','sb = 0.2 dopado 10^9'},'Location', 'best'); 
