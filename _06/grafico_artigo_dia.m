...
op7 =  rdcelpa('p_esq_artigo_d18_b102_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('p_dir_artigo_d18_b102_dd_iv.elpa','*',[],op7);

op7 =  rdcelpa('p_esq_artigo_d18_b002_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('p_dir_artigo_d18_b002_dd_iv.elpa','*',[],op7);

op7 =  rdcelpa('p_esq_artigo_d18_b0025_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('p_dir_artigo_d18_b0025_dd_iv.elpa','*',[],op7);

op7 =  rdcelpa('p_esq_artigo_d18_b003_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('p_dir_artigo_d18_b003_dd_iv.elpa','*',[],op7);
...
legend([h(1) h(2) h(4) h(6) h(8)],...
    {'Experimental', 'sb = -0.2','sb = 0.2', 'sb = 0.25', 'sb = 0.3'},'Location', 'best'); 
