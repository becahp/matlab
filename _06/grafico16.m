...
% use them, we close 03_all_bbt1_16 figures, and then repeat the first example.
close all;
...
% op7 =  rdcelpa('03_all_bbt1_16/n_esq_3g_bbt1_d16_dd_iv.elpa','*',[],op7);
% op7 =  rdcelpa('03_all_bbt1_16/n_dir_3g_bbt1_d16_dd_iv.elpa','*',[],op7);
% op7 =  rdcelpa('03_all_bbt1_16/p_esq_3g_bbt1_d16_dd_iv.elpa','*',[],op7);
% op7 =  rdcelpa('03_all_bbt1_16/p_dir_3g_bbt1_d16_dd_iv.elpa','*',[],op7);

op7 =  rdcelpa('03_3g_d16/n_esq_3g_12V_d16_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('03_3g_d16/n_dir_3g_12V_d16_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('03_3g_d16/p_esq_3g_12V_d16_dd_iv.elpa','*',[],op7);
op7 =  rdcelpa('03_3g_d16/p_dir_3g_12V_d16_dd_iv.elpa','*',[],op7);
end
...
legend([h(1) h(5) h(9) h(13)],...
    {'1G','FBG','2G','3G'},'Position',[0.65,0.55,0.25,0.1])
%print('4estruturas', '-depsc')
legend('boxoff');

print('Fig_7a_old', '-depsc')