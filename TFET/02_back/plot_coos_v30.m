...
%%%%%%%%%%%%%%%outros band diagram
%[A,a,fl] = readELPA('nLP_PGS_10/nLP_PGS_10_op111_dd_inqu.elpa'); %0.3V 
%[A,a,fl] = readELPA('nLP_BG_006/nLP_BG_006_op50_dd_inqu.elpa'); %0.3V 

%[A,a,fl] = readELPA('nLP_PGS_10/nLP_PGS_10_op41_dd_inqu.elpa'); %1V 
[A,a,fl] = readELPA('nLP_BG_006/nLP_BG_006_op1_dd_inqu.elpa'); %1V 
