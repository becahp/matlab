...
%op2 =  rdcelpa('nHP_BG_110_dd_iv.elpa','*',[],op2); % errado
...
op2 =  rdcelpa('nLP_BG_110_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_BG_106_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_BG_102_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_BG_002_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_BG_006_dd_iv.elpa','*',[],op2);
%op2 =  rdcelpa('nLP_BG_010_dd_iv.elpa','*',[],op2); % errado
end
...
op2 =  rdcelpa('nLP_BG_014_dd_iv.elpa','*',[],op2);  
end
...
if aux == 1
legend({'VPG = 1.0V','VBG = -0.6V','VBG = -0.2V','VBG = 0.2V','VBG = 0.6V','VBG = 1.0V'}, 'Location', 'best');
end
...
if aux == 3
%legend({'VPG = -1.0V','VBG = -0.6V','VBG = -0.2V','VBG = 0.2V','VBG = 0.6V','VBG = 1.0V','VBG = 1.4V'}, 'Location', 'best');
legend({'VPG = -1.0V','VBG adpt','VBG = -0.2V','VBG = 0.2V','VBG = 0.6V','VBG = 1.0V','VBG = 1.4V'}, 'Location', 'best');
end

if aux == 4
legend({'VPG = -1.0V','VBG adpt','VBG = 0.6V','VBG = 1.0V','VBG = 1.4V'}, 'Location', 'best');
end
...
legend([h(1) h(3) h(5)],{'VBG = -1.0V','VBG = -0.6V','VBG = -0.2V'}, 'Location', 'best');
legend('boxoff')
print('BG_neg', '-depsc');
...
h(4) = semilogy(op2(10).V_g,op2(10).I_s);
h(5) = semilogy(op2(11).V_g,op2(11).I_s);
h(6) = semilogy(op2(12).V_g,op2(12).I_s);
hold off;
...
legend([h(1) h(3) h(5)],{'VBG = 0.2V','VBG = 0.6V','VBG = 1.0V'}, 'Location', 'best');
legend('boxoff')
