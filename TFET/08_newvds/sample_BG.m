...
op2 =  rdcelpa('nHP_BG_000_30_vds05_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_BG_000_30_vds05_dd_iv.elpa','*',[],op2);

op2 =  rdcelpa('nHP_BG_000_35_vds05_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_BG_000_35_vds05_dd_iv.elpa','*',[],op2);
...
%legend({'tox = 25nm', 'tox = 30nm','tox = 35nm'}, 'Location', 'best');
