...
if aux == 1
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\TFET\02_PGD_var\00_dia
op2 =  rdcelpa('nHP_PGS_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_PGS_dd_iv.elpa','*',[],op2);

op2 =  rdcelpa('nHP_PGD_dia12_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_PGD_dia12_dd_iv.elpa','*',[],op2);

op2 =  rdcelpa('nHP_PGD_dia10_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_PGD_dia10_dd_iv.elpa','*',[],op2);
end

if aux == 2
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\TFET\02_PGD_var\01_VPGS

op2 =  rdcelpa('nHP_PGS_08_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_PGS_08_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_PGS_10_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_PGS_10_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_PGS_12_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_PGS_12_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_PGS_14_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_PGS_14_dd_iv.elpa','*',[],op2);
end
...
legend([h(1) h(3) h(5)],{'dia = 1.4nm','dia = 1.2nm','dia = 1.0nm'}, 'Location', 'best');
legend('boxoff')

print('pgs_var_dia', '-depsc');
end
...
if aux == 2
legend([h(1) h(3) h(5) h(7)],{'Vpgs = 0.8V','Vpgs = 1.0V','Vpgs = 1.2V','Vpgs = 1.4V'}, 'Location', 'best');
legend('boxoff')

print('pgs_var_pgs', '-depsc');
end

if aux == 3
legend([h(1) h(3) h(5) h(7)],{'Vpgs = 0.8V n','Vpgs = 1.0V n','Vpgs = 1.2V n','Vpgs = 1.4V n'}, 'Location', 'best');
legend('boxoff')

print('pgs_var_pgs_n', '-depsc');
end
...
legend([h(1) h(3) h(5)],{'sp = 5nm','sp = 10nm','sp = 20nm'}, 'Location', 'best');
legend('boxoff')

print('pgs_var_sp', '-depsc');
end
