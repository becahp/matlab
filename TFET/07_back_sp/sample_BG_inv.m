...
op2 =  rdcelpa('nHP_BG_inv_10_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_BG_inv_10_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_BG_inv_15_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_BG_inv_15_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nHP_BG_inv_25_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('nLP_BG_inv_25_dd_iv.elpa','*',[],op2);
