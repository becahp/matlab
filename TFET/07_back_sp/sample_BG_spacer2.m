...
op2 =  rdcelpa('nHP_BG_000_10_dd_iv.elpa','*',[],op2); % VBG = 0.0V
op2 =  rdcelpa('nLP_BG_000_10_dd_iv.elpa','*',[],op2); % VBG = 0.0V
...
legend([h(1) h(3) h(5) h(7) h(9) h(11)],{'manual shift', 'VBG = 0.6V', 'VBG = 0.2V', 'VBG = 0.0V', 'VBG = -0.2V', 'VBG = -0.4V'}, 'Location', 'best');
