...
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\TFET\04_hipotese\03_assimetrica
...
%if aux == 1
op2 =  rdcelpa('nHP_as_02_10_dd_iv.elpa','*',[],op2);	%BG sp 40
op2 =  rdcelpa('nHP_as_02_12_dd_iv.elpa','*',[],op2);	%BG sp 40
op2 =  rdcelpa('nHP_as_04_12_dd_iv.elpa','*',[],op2);	%BG sp 40
op2 =  rdcelpa('nHP_as_18_10_dd_iv.elpa','*',[],op2);	%BG sp 40

op2 =  rdcelpa('nHP_sp_40_dd_iv.elpa','*',[],op2);		%sp 40
%op2 =  rdcelpa('nLP_PGS_dd_iv.elpa','*',[],op2);		%sp 40
%end

%if aux == 2
op2 =  rdcelpa('nLP_as_02_10_dd_iv.elpa','*',[],op2);	%BG sp 40
op2 =  rdcelpa('nLP_as_02_12_dd_iv.elpa','*',[],op2);	%BG sp 40
op2 =  rdcelpa('nLP_as_04_12_dd_iv.elpa','*',[],op2);	%BG sp 40
op2 =  rdcelpa('nLP_as_18_10_dd_iv.elpa','*',[],op2);	%BG sp 40
...
%legend({'dv = 0.2, vpg = 1.0','dv = 0.2, vpg = 1.2','dv = 0.4, vpg = 1.2','dv = 0, vpg = 1.0' }, 'Location', 'best');
legend('boxoff')
