...
for k=1:length(list)
   ...
   if ~iscell(var{1}),
      ...
      h=xlabel('Tensão de dreno (V)');
      set(h,'Interpreter','tex')
      %h=ylabel(char(var{1:length(var)-1}));
      h=ylabel('Corrente de dreno (µA)');
      set(h,'Interpreter','none')
      h=legend(lgnd);
      %h=legend('tipo n', 'tipo p');
      set(h,'Interpreter','none')
      %annotation('textbox','String','V_{G1} = 1','Interpreter','tex','FontSize', 12);
      
      %annotation('textbox','String','V_{G1} = 1 V','Interpreter','tex','FontSize', 12, 'LineStyle', 'none', 'Position', [0.139 0.442 0.168 0.112] );
      %annotation('textbox','String','V_{G1} = 1.5 V','Interpreter','tex','FontSize', 12, 'LineStyle', 'none');
      %annotation('textbox','String','V_{G1} = 2 V','Interpreter','tex','FontSize', 12, 'LineStyle', 'none');
