...
op1 = rdcelpa('n_dir_meff_004_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_004_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_01_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_01_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_02_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_02_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_03_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_03_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_04_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_04_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_05_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_05_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_06_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_06_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_07_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_07_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_08_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_08_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_09_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_09_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_esq_meff_10_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('n_dir_meff_10_dd_iv.elpa','*',[],op1);
...
axis([-0.2 2 1E-11 0.0001])
xlabel('V_{gs} (V)')
ylabel('I_{ds} (A)')

ay = gca;
ay.YTick = [1e-12 1e-10 1e-8 1e-6 1e-4];
%- Curvas de meff (antigas): de 0 a 2, 8e-11 a 1e4 (com passos de 2)
