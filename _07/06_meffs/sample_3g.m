...
op1 = rdcelpa('3g/n_dir_3g_meff_004_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_004_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_01_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_01_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_02_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_02_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_03_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_03_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_04_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_04_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_05_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_05_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_06_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_06_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_07_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_07_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_08_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_08_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_09_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_09_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_esq_3g_meff_10_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('3g/n_dir_3g_meff_10_dd_iv.elpa','*',[],op1);
...
%axis([-0.2 1.2 0.1E-10 0.0001])
axis([-0.2 1.2 8E-11 0.0001])
xlabel('V_{gs} (V)')
ylabel('I_{ds} (A)')
...
annotation('textbox','String',s,...
   ...
   [0.16 0.74 0.065 0.066],... %[0.29 0.53 0.065 0.066],...
   'FitBoxToText','on');

annotation('textbox','String',s1,...
   'FontSize', 20, 'LineStyle', 'none', 'Position',...
   [0.26 0.30 0.065 0.066],...%[0.56 0.4 0.065 0.066],...
   'FitBoxToText','on');
end
...
annotation('textbox','String',s,...
   'FontSize', 20, 'LineStyle', 'none', 'Position',...
   [0.16 0.61 0.065 0.066],... %[0.29 0.53 0.065 0.066],...
   'FitBoxToText','on');

annotation('textbox','String',s1,...
   'FontSize', 20, 'LineStyle', 'none', 'Position',...
   [0.33 0.22 0.065 0.066],...%[0.56 0.4 0.065 0.066],...
   'FitBoxToText','on');
end
								%[x_begin y_begin dx dy].
annotation('arrow', 'Position', [0.7 0.75 0.1 -0.3]);

annotation('textbox','String','m_{eff}',...
    'FontSize', 20, 'LineStyle', 'none', 'Position',...
    [0.65 0.78 0.065 0.066],...
    'FitBoxToText','on');

%hold off;

%print('Fig_10d', '-depsc');
print('Fig_10d_12', '-depsc');
