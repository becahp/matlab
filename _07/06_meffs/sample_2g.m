...
op1 = rdcelpa('2g/n_dir_meff_004_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_004_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_01_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_01_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_02_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_02_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_03_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_03_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_04_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_04_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_05_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_05_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_06_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_06_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_07_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_07_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_08_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_08_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_09_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_09_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_esq_meff_10_dd_iv.elpa','*',[],op1);
op1 = rdcelpa('2g/n_dir_meff_10_dd_iv.elpa','*',[],op1);
...
annotation('textbox','String',s,...
    ...
    [0.16 0.58 0.065 0.066],... %[0.20 0.58 0.065 0.066],...
    'FitBoxToText','on');

annotation('textbox','String',s1,...
    'FontSize', 20, 'LineStyle', 'none', 'Position',...
    [0.39 0.20 0.065 0.066],...
    'FitBoxToText','on');
