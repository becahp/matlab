...
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\_07v30\09_meffvarias\transfer\1G
...
addpath C:\Users\becahp\UnB\Artigo\Simulacoes\_07v30\09_meffvarias\transfer\FBG
...
%op2(1) = unir_op(op3);
[op2(1).V_g, op2(1).I_s] = unir_op(op3);
...
%
%[op2(2).V_g, op2(2).I_s] = unir_op(op3);
%op2(2).I_s = smooth(op2(2).I_s);

op2 = rdcelpa('re/n_2g_vsup_meff_01_v3_dd_iv.elpa','*',[],op2);
%op2 = rdcelpa('re/n_2g_vsup_meff_01_v4_dd_iv.elpa','*',[],op2);
...
%peak_gm2(aux,i) = plot_elpa_gmp(op2(i)); 	%pega os gm,peak
	...
	if aux == 1
		...
		elseif aux == 3
			...
			gms(aux, i) = gm2G(i).y(find(gm2G(i).x>=1 & gm2G(i).x<=1.05,1));
