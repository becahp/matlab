...
%(dia = 1.6/2.4nm) %V_g= -5.517241379E-001
...
%data = ['n_esq_3g/n_esq_3g_op9_dd_inqu.elpa        ';
%        'n_esq_3g_d24/n_esq_3g_d24_op9_dd_inqu.elpa'];
%str = struct('elpa',value)
...
%% segundo
[A,a,fl] = readELPA('n_esq_3g_d24/n_esq_3g_d24_op9_dd_inqu.elpa');

%[A,a,fl] = readELPA('n_esq_3g_d16_gate_v3/n_esq_3g_d16_gate_v3_op9_dd_inqu.elpa');
%[A,a,fl] = readELPA('n_3g_d16_program_18V/n_3g_d16_program_18V_op26_dd_inqu.elpa');
%[A,a,fl] = readELPA('n_3g_d16_dreno_14V/n_3g_d16_dreno_14V_op26_dd_inqu.elpa');
...
% plot(x,cb1,'k','linewidth',2);hold on
%else
 plot(x,cb1,'b','linewidth',2);hold on
 %plot(x,qfn,'b--','linewidth',2);hold on
 plot(x,vb1,'g','linewidth',2);hold on
 %plot(x,qfp,'g--','linewidth',2);hold on
%end        
