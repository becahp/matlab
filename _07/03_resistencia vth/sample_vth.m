...
if sel == 4 
op2 =  rdcelpa('n_dir_1g_vth_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('n_dir_fbg_vth_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('n_dir_2g_vth_dd_iv.elpa','*',[],op2);
op2 =  rdcelpa('n_dir_3g_vth_dd_iv.elpa','*',[],op2);
end
